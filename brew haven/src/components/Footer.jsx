            ...
            <div className='bg-black/40 min-h-[400px]'>
                <div className='max-w-7xl mx-auto grid md:grid-cols-3 pb-20 pt-5'>
                    ...
                    <div className='py-8 px-4'>
                        ...
                        <a href="https://www.youtube.com/" target='_blank' className='inline-block bg-[#3d2517] py-2 px-4 mt-5 text-sm rounded-full'>Visit our YouTube Channel</a>
                    </div>
                    {/* footer links */}
                    <div className='col-span-2 grid grid-cols-2 sm:grid-cols-3 md:pl-10'>
                        ...
                        <div className='py-8 px-4 col-span-2 sm:col-auto'>
                            ...
                            <div>
                                <p className='mb-3'>Kathmandu, Sesmati</p>
                                <p>+977 9812345678</p>
                                {/* social links */}
